-- ── Create Finance and HR databases on local postgres ──────────────────────

-- Finance DB
CREATE DATABASE ongc_finance;
\c ongc_finance
...
('E&P Operations','Q1',2026,45000000,38200000),
('Refinery','Q1',2026,32000000,29800000),
('HR & Admin','Q1',2026,8500000,7200000),
('IT Infrastructure','Q1',2026,12000000,9800000),
('Safety & Environment','Q1',2026,6000000,5100000),
('E&P Operations','Q2',2026,43200000,21500000),
('Refinery','Q2',2026,35000000,18200000),
('HR & Admin','Q2',2026,9000000,4100000),
('IT Infrastructure','Q2',2026,11000000,5600000),
('Safety & Environment','Q2',2026,6500000,3200000),
('E&P Operations','Q3',2026,47000000,0),
('Refinery','Q3',2026,36000000,0),
('HR & Admin','Q3',2026,9500000,0),
('IT Infrastructure','Q3',2026,13000000,0),
('Safety & Environment','Q3',2026,7000000,0),
('E&P Operations','Q4',2026,48000000,0),
('Refinery','Q4',2026,37000000,0);
...
('Cisco Systems India',6200000,'IT Infrastructure','2026-04-05','GM-IT','approved'),
('Yokogawa India',10500000,'Refinery','2026-04-10','GM-REF','approved'),
('Emerson India',8500000,'E&P Operations','2026-04-12','GM-OPS','approved'),
('Wipro Technologies',5000000,'IT Infrastructure','2026-04-18','GM-IT','approved');

-- GL entries
INSERT INTO gl_entries (account_code, account_name, debit_amount, credit_amount, entry_date, description, department) VALUES
('1001','Cash & Bank Equivalents',0,45000000,'2026-04-01','Q1 Operating Cash Release','Finance'),
('5001','E&P Operating Expenses',38200000,0,'2026-04-30','Q1 E&P Operations Expenses','E&P Operations'),
('5002','Refinery Operating Expenses',29800000,0,'2026-04-30','Q1 Refinery Expenses','Refinery'),
('5003','HR & Admin Expenses',7200000,0,'2026-04-30','Q1 HR & Admin Expenses','HR & Admin'),
('5004','IT Infrastructure Expenses',9800000,0,'2026-04-30','Q1 IT Expenses','IT Infrastructure'),
('5005','Safety & Environment Expenses',5100000,0,'2026-04-30','Q1 Safety Expenses','Safety & Environment'),
('1001','Cash & Bank Equivalents',0,43200000,'2026-05-01','Q2 Operating Cash Release','Finance'),
('5001','E&P Operating Expenses',21500000,0,'2026-05-31','Q2 E&P Expenses (partial)','E&P Operations'),
('5002','Refinery Operating Expenses',18200000,0,'2026-05-31','Q2 Refinery Expenses (partial)','Refinery'),
...
('4002','Revenue from Petroleum Products',0,185000000,'2026-04-30','April 2026 Products Revenue','Finance'),
('4002','Revenue from Petroleum Products',0,192000000,'2026-05-31','May 2026 Products Revenue','Finance');
